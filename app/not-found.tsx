...
export default function NotFound() {
  return (
    <div
      ...
      bg-white text-neutral-900 dark:from-neutral-900 dark:to-neutral-950 dark:text-white transition-colors duration-300"
    >
      {/* 404 Number */}
      <h1 className="text-8xl md:text-9xl font-extrabold text-teal-500">404</h1>
